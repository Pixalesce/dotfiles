...
vim.keymap.set('n', '<C-j>', function() miniharp.go_to(3) end, { desc = 'miniharp: go to mark 3' })
vim.keymap.set('n', '<C-l>', function() miniharp.go_to(4) end, { desc = 'miniharp: go to mark 4' })
vim.keymap.set('n', '<C-q>', function() miniharp.go_to(3) end, { desc = 'miniharp: go to mark 3' })
vim.keymap.set('n', '<C-s>', function() miniharp.go_to(4) end, { desc = 'miniharp: go to mark 4' })
